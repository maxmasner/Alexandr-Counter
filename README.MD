...
Push to `main` → GitHub Actions validates compose + Dockerfile, builds/pushes image to registry, then triggers Dokploy redeploy webhook.
...
| `DOKPLOY_DEPLOY_WEBHOOK` | Dokploy deploy webhook URL |
